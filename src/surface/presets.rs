...
fn red_stone() -> SurfaceDef {
    SurfaceDef {
        ...
        secondary_color: Some((0.78, 0.75, 0.65)),
        ..Default::default()
    }
}
...
fn marble() -> SurfaceDef {
    SurfaceDef {
        ...
        color_variation: (0.15, 0.15, 0.15),
        noise_scale: 0.03,
        noise_octaves: 4,
...
fn wood_plank() -> SurfaceDef {
    SurfaceDef {
        ...
        color_variation: (0.12, 0.12, 0.12),
        noise_scale: 0.06,
        noise_octaves: 3,
...
fn metal_plate() -> SurfaceDef {
    SurfaceDef {
        ...
        color_variation: (0.02, 0.02, 0.02),
        noise_scale: 0.2,
        noise_octaves: 1,
        pattern: PatternType::Perlin,
        roughness: 0.3,
...
fn brushed_metal() -> SurfaceDef {
    SurfaceDef {
        ...
        color_variation: (0.05, 0.05, 0.06),
        noise_scale: 12.0,
        noise_octaves: 2,
        pattern: PatternType::Perlin,
        roughness: 0.3,
...
fn dark_composite() -> SurfaceDef {
    SurfaceDef {
        ...
        color_variation: (0.03, 0.03, 0.04),
        noise_scale: 20.0,
        noise_octaves: 2,
        pattern: PatternType::Perlin,
        roughness: 0.4,
